...
def test_git_log_reads_any_ref_and_teaches_refresh(
...
def test_git_diff_reviews_a_branch_against_default(
    repo: Path, config: SupervisorConfig
) -> None:
...
def test_list_worktrees_joins_git_state_with_runs(
    repo: Path, config: SupervisorConfig
) -> None:
...
def test_create_branch_carded_verb_and_refusals(
    repo: Path, config: SupervisorConfig
) -> None:
...
def test_merge_branch_never_writes_the_default_branch(
    repo: Path, config: SupervisorConfig
) -> None:
