...
def test_registered_slug_dispatches_are_unaffected(repo: Path, config: SupervisorConfig) -> None:
...
def test_missing_path_deny_names_the_registered_repos(repo: Path, config: SupervisorConfig) -> None:
